        ...
        <div>
          ...
          <ul className="text-theme_grayishViolet">
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">Link Shortening</a>
            </li>
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">Branded Links</a>
            </li>
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">Analytics</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="text-theme_grayishViolet">
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">Blog</a>
            </li>
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">Developers</a>
            </li>
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">Support</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="text-theme_grayishViolet">
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">About</a>
            </li>
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">Our Team</a>
            </li>
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">Careers</a>
            </li>
            <li className="leading-8">
              <a href="#" className="hover:text-theme_cyan transition-all ease-in-out">Contact</a>
            </li>
          </ul>
        </div>
      </div>
      <div className="flex justify-center space-x-5">
        <a href="#" className="text-white hover:text-theme_cyan transition-all ease-in-out">
