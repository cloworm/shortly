...
const Features = (): ReactElement => {
  return (
    <div className="bg-theme_lightGray pt-20 lg:pt-32 pb-12 lg:pb-20">
      <h2 className="font-bold text-theme_darkViolet text-2xl lg:text-4xl text-center">
        Advanced Statistics
      </h2>
      <p className="text-theme_grayishViolet pt-6 lg:pt-4 pb-8 px-9 lg:px-112 text-sm lg:text-base leading-6 lg:leading-8 text-center">
        Track how your links are performing across the web with our advanced statistics dashboard.
      </p>
      <div className="px-6 lg:px-32 py-8 lg:py-10">
        <div className="flex flex-col lg:flex-row space-y-16 lg:space-y-0 lg:space-x-7 bg-stripe-v lg:bg-stripe-h">
          <div>
            <FeatureCard
